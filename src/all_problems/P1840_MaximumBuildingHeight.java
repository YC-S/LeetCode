...
public class P1840_MaximumBuildingHeight {
  public int maxBuilding(int n, int[][] restrictions) {
    ...
    for (int[] restriction : restrictions) {
      ...
      if (ph < h) {
        ...
        // The steps are, first move up to 2, then we have 4 steps, go 2 up to height 4, then 2 down
        // back to 2, so highest is 4
        // H    1 2 3 4 3 2
        // ind  1         6
