...
public class P1857_LargestColorValueInADirectedGraph {
  private int max;
  ...
  private Map<Character, Integer> dfs(
      int curr, Map<Integer, List<Integer>> map, String colors, boolean[] visited) {
    if (visited[curr]) {
      hasCycle = true;
      return new HashMap<>();
    }
