    ...
    for (int distance = 1; distance < len; distance++) {
      for (int i = 0; i < len - distance; i++) {
        ...
        if (chs[i] == chs[j]) {
          ...
          if (low > high) {
            // consider the string from i to j is "a...a" "a...a"... where there is no character 'a'
            ...
            */
            ...
            // consider the string from i to j is "a...a...a... a" where there are at least two
            // character 'a' close to leftmost and rightmost 'a'
        ...
        dp[i][j] = dp[i][j] < 0 ? dp[i][j] + 1_000_000_007 : dp[i][j] % 1_000_000_007;
      }
    }
